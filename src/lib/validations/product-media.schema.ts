...
export const productMediaUploadRequestSchema = z.object({
  fileName: z.string().trim().min(1, "File name is required").max(255),
  contentType: z.enum(ALLOWED_IMAGE_MIME_TYPES as unknown as [string, ...string[]], {
...
export type ProductMediaUploadRequestInput = z.infer<typeof productMediaUploadRequestSchema>;
